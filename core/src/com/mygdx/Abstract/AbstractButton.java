...
//	}	
	...
	/**
	 * Set the lock, it overrides the hit method, so it wont detect hits, also if it is active, lock texture will be drawn
	 * 
	 * @see hit()
	 * */
	 ...
	 * 
	 * @param bitMapFont font for text
	...
	/**
	 * Set external texture, it is all optional. This is for extra texture region to be drawn over everything
	 * <p>
	 * EXAMPLE<br>
	 * A menu button and there is a mini coin texture over the button in the right side
	 */
